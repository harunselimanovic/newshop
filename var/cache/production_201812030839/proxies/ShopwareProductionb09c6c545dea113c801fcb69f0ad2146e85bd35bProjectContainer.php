...
class ShopwareProductionb09c6c545dea113c801fcb69f0ad2146e85bd35bProjectContainer extends \Shopware\Components\DependencyInjection\Container
{
    private $parameters;
    ...
    {
        return $this->services['frosh_profiler.cache'] = new \Doctrine\Common\Cache\FilesystemCache('/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/FroshProfiler');
    }
    ...
    {
        return $this->services['frosh_profiler.subscriber.cache'] = new \FroshProfiler\Subscriber\CacheSubscriber('/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/FroshProfiler', '/Applications/MAMP/htdocs/shopware/custom/plugins/FroshProfiler/Resources/views');
    }
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/Applications/MAMP/htdocs/shopware/var/log/core_production.log', 14, 400);
    ...
    protected function getPluginloggerService()
    {
        ...
        $a = new \Monolog\Handler\RotatingFileHandler('/Applications/MAMP/htdocs/shopware/var/log/plugin_production.log', 14, 400);
        $a->pushProcessor(${($_ = isset($this->services['monolog.processor.uid']) ? $this->services['monolog.processor.uid'] : $this->get('monolog.processor.uid')) && false ?: '_'});
    ...
    protected function getShopware_Emotion_PresetDataSynchronizerService()
    {
        ...
        }, 4), '/Applications/MAMP/htdocs/shopware/');
    }
    ...
    {
        return $this->services['shopware.esd.public.url_generator'] = new \Shopware\Components\Filesystem\PublicUrlGenerator($this, '/Applications/MAMP/htdocs/shopware', '/Applications/MAMP/htdocs/shopware/files');
    }
    ...
    {
        return $this->services['shopware.filesystem.public.url_generator'] = new \Shopware\Components\Filesystem\PublicUrlGenerator($this, '/Applications/MAMP/htdocs/shopware/', '/Applications/MAMP/htdocs/shopware/web', '');
    }
    ...
    protected function getShopware_GenericControllerListenerService()
    {
        ...
        $instance->addController('Enlight_Controller_Dispatcher_ControllerPath_Frontend_Profiler', '/Applications/MAMP/htdocs/shopware/custom/plugins/FroshProfiler/Controllers/Frontend/Profiler.php');
        return $instance;
    }
    ...
    {
        return $this->services['shopware.openssl_verificator'] = new \Shopware\Components\OpenSSLVerifier('/Applications/MAMP/htdocs/shopware/engine/Shopware/Components/HttpClient/public.key');
    }
    ...
    {
        return $this->services['shopware.requirements'] = new \Shopware\Components\Check\Requirements('/Applications/MAMP/htdocs/shopware/engine/Shopware/Components/Check/Data/System.xml', ${($_ = isset($this->services['db_connection']) ? $this->services['db_connection'] : $this->get('db_connection')) && false ?: '_'});
    }
    ...
    {
        return $this->services['shopware.snippet_database_handler'] = new \Shopware\Components\Snippet\DatabaseHandler(${($_ = isset($this->services['models']) ? $this->services['models'] : $this->get('models')) && false ?: '_'}, ${($_ = isset($this->services['db']) ? $this->services['db'] : $this->get('db')) && false ?: '_'}, '/Applications/MAMP/htdocs/shopware');
    }
    protected function getShopware_SnippetQueryHandlerService()
    {
        return $this->services['shopware.snippet_query_handler'] = new \Shopware\Components\Snippet\QueryHandler('/Applications/MAMP/htdocs/shopware/snippets/');
    }
    ...
    protected function getTemplateService()
    {
        ...
        $instance->addPluginsDir('/Applications/MAMP/htdocs/shopware/custom/plugins/FroshProfiler/Resources/smarty');
        return $instance;
    }
    ...
    {
        return $this->services['theme_path_resolver'] = new \Shopware\Components\Theme\PathResolver('/Applications/MAMP/htdocs/shopware/', $this->parameters['shopware.plugin_directories'], '/Applications/MAMP/htdocs/shopware/themes/', '/Applications/MAMP/htdocs/shopware/web/cache/', ${($_ = isset($this->services['shopware.release']) ? $this->services['shopware.release'] : $this->get('shopware.release')) && false ?: '_'});
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Applications/MAMP/htdocs/shopware',
            'kernel.environment' => 'production',
            'kernel.debug' => false,
            'kernel.name' => 'Shopware',
            'kernel.cache_dir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839',
            'kernel.logs_dir' => '/Applications/MAMP/htdocs/shopware/var/log',
            'kernel.charset' => 'utf8',
            'kernel.container_class' => 'ShopwareProductionb09c6c545dea113c801fcb69f0ad2146e85bd35bProjectContainer',
            ...
            'shopware.filesystem' => array(
                'private' => array(
                    'type' => 'local',
                    'config' => array(
                        'root' => '/Applications/MAMP/htdocs/shopware/files',
                    ),
                ),
                'public' => array(
                    'type' => 'local',
                    'config' => array(
                        'root' => '/Applications/MAMP/htdocs/shopware/web',
                        'url' => '',
                    ),
                ),
            ),
            ...
            'shopware.filesystem.private.config.root' => '/Applications/MAMP/htdocs/shopware/files',
            ...
            'shopware.filesystem.public.config.root' => '/Applications/MAMP/htdocs/shopware/web',
            ...
            'shopware.cdn' => array(
                ...
                'adapters' => array(
                    'local' => array(
                        ...
                        'root' => '/Applications/MAMP/htdocs/shopware',
                    ),
                    'ftp' => array(
                        'type' => 'ftp',
                        'mediaUrl' => '',
            ...
            'shopware.cdn.adapters.local.root' => '/Applications/MAMP/htdocs/shopware',
            ...
            'shopware.plugin_directories' => array(
                'Default' => '/Applications/MAMP/htdocs/shopware/engine/Shopware/Plugins/Default/',
                'Local' => '/Applications/MAMP/htdocs/shopware/engine/Shopware/Plugins/Local/',
                'Community' => '/Applications/MAMP/htdocs/shopware/engine/Shopware/Plugins/Community/',
                'ShopwarePlugins' => '/Applications/MAMP/htdocs/shopware/custom/plugins/',
                'ProjectPlugins' => '/Applications/MAMP/htdocs/shopware/custom/project/',
            ),
            'shopware.plugin_directories.Default' => '/Applications/MAMP/htdocs/shopware/engine/Shopware/Plugins/Default/',
            'shopware.plugin_directories.Local' => '/Applications/MAMP/htdocs/shopware/engine/Shopware/Plugins/Local/',
            'shopware.plugin_directories.Community' => '/Applications/MAMP/htdocs/shopware/engine/Shopware/Plugins/Community/',
            'shopware.plugin_directories.ShopwarePlugins' => '/Applications/MAMP/htdocs/shopware/custom/plugins/',
            'shopware.plugin_directories.ProjectPlugins' => '/Applications/MAMP/htdocs/shopware/custom/project/',
            'shopware.template' => array(
                ...
                'charset' => 'utf-8',
                'forceCache' => false,
                'cacheDir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/templates',
                'compileDir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/templates',
                'templateDir' => '/Applications/MAMP/htdocs/shopware/themes/',
            ),
            ...
            'shopware.template.cacheDir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/templates',
            'shopware.template.compileDir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/templates',
            'shopware.template.templateDir' => '/Applications/MAMP/htdocs/shopware/themes/',
            'shopware.mail' => array(
                'charset' => 'utf-8',
            ),
            ...
            'shopware.httpcache' => array(
                ...
                'cache_dir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/html',
                'cache_cookies' => array(
                    0 => 'shop',
                    1 => 'currency',
            ...
            'shopware.httpcache.cache_dir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/html',
            ...
            'shopware.cache' => array(
                'frontendOptions' => array(
                    ...
                    'lifetime' => 3600,
                    'cache_id_prefix' => 'b938582fb85863b7628748a1d1df3a60',
                ),
                'backend' => 'auto',
                'backendOptions' => array(
                    ...
                    'cache_dir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/general',
            ...
            'shopware.cache.frontendOptions.cache_id_prefix' => 'b938582fb85863b7628748a1d1df3a60',
            ...
            'shopware.cache.backendOptions.cache_dir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/general',
            'shopware.cache.backendOptions.file_name_prefix' => 'shopware',
            'shopware.hook' => array(
                'proxyDir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/proxies',
                'proxyNamespace' => 'Shopware_Proxies',
            ),
            'shopware.hook.proxyDir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/proxies',
            'shopware.hook.proxyNamespace' => 'Shopware_Proxies',
            'shopware.model' => array(
                'autoGenerateProxyClasses' => false,
                'attributeDir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/doctrine/attributes',
                'proxyDir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/doctrine/proxies',
                'proxyNamespace' => 'Shopware\\Proxies',
                'cacheProvider' => 'auto',
                'cacheNamespace' => NULL,
            ),
            'shopware.model.autoGenerateProxyClasses' => false,
            'shopware.model.attributeDir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/doctrine/attributes',
            'shopware.model.proxyDir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/doctrine/proxies',
            ...
            'shopware.app' => array(
                'rootDir' => '/Applications/MAMP/htdocs/shopware/',
                'downloadsDir' => '/Applications/MAMP/htdocs/shopware/files/downloads/',
                'documentsDir' => '/Applications/MAMP/htdocs/shopware/files/documents/',
            ),
            'shopware.app.rootDir' => '/Applications/MAMP/htdocs/shopware/',
            'shopware.app.downloadsDir' => '/Applications/MAMP/htdocs/shopware/files/downloads/',
            'shopware.app.documentsDir' => '/Applications/MAMP/htdocs/shopware/files/documents/',
            'shopware.web' => array(
                'webDir' => '/Applications/MAMP/htdocs/shopware/web/',
                'cacheDir' => '/Applications/MAMP/htdocs/shopware/web/cache/',
            ),
            'shopware.web.webDir' => '/Applications/MAMP/htdocs/shopware/web/',
            'shopware.web.cacheDir' => '/Applications/MAMP/htdocs/shopware/web/cache/',
            'shopware.mpdf' => array(
                'defaultConfig' => array(
                    'tempDir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/mpdf/',
                    'fontDir' => '/Applications/MAMP/htdocs/shopware/engine/Library/Mpdf/ttfonts//',
                    'fonttrans' => array(
                        'helvetica' => 'arial',
                        'verdana' => 'arial',
                        'times' => 'timesnewroman',
            ...
            'shopware.mpdf.defaultConfig.tempDir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/mpdf/',
            'shopware.mpdf.defaultConfig.fontDir' => '/Applications/MAMP/htdocs/shopware/engine/Library/Mpdf/ttfonts//',
            ...
            'frosh_profiler.plugin_dir' => '/Applications/MAMP/htdocs/shopware/custom/plugins/FroshProfiler',
            'frosh_profiler.plugin_name' => 'FroshProfiler',
            'kernel.project_dir' => '/Applications/MAMP/htdocs/shopware',
            'var_dump_server' => '127.0.0.1:9912',
            'frosh_profiler.cache_dir' => '/Applications/MAMP/htdocs/shopware/var/cache/production_201812030839/FroshProfiler',
            'frosh_profiler.view_dir' => '/Applications/MAMP/htdocs/shopware/custom/plugins/FroshProfiler/Resources/views',
            'frosh_profiler.smarty_dir' => '/Applications/MAMP/htdocs/shopware/custom/plugins/FroshProfiler/Resources/smarty',
            'frosh_profiler.smarty_default_plugin_dir' => '/Applications/MAMP/htdocs/shopware/custom/plugins/FroshProfiler/Components/Smarty/sysplugins/',
