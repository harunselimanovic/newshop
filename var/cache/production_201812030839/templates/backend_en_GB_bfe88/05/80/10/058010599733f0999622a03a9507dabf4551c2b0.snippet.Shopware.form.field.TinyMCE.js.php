<?php /* Smarty version Smarty-3.1.12, created on 2018-12-09 15:06:43
         compiled from "/Applications/MAMP/htdocs/newshop/themes/Backend/ExtJs/backend/base/component/Shopware.form.field.TinyMCE.js" */ ?>
<?php /*%%SmartyHeaderCode:15113095325c0d2173a527e5-47148473%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '058010599733f0999622a03a9507dabf4551c2b0' => 
    array (
      0 => '/Applications/MAMP/htdocs/newshop/themes/Backend/ExtJs/backend/base/component/Shopware.form.field.TinyMCE.js',
      1 => 1543822814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15113095325c0d2173a527e5-47148473',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c0d2173ac0035_98840716',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c0d2173ac0035_98840716')) {function content_5c0d2173ac0035_98840716($_smarty_tpl) {?>/**
 * Shopware 5
...
",
            ...
            document_base_url: '<?php ob_start();?><?php echo 'http://localhost:8888/newshop/backend';?><?php $_tmp1=ob_get_clean();?><?php echo $_tmp1;?>
/'.replace('/backend', ''),
            
            // Content CSS - Styles the tiny mce editor. Please note the append timestamp. It's used to prevent caching the stylesheet
            contentCSS: 'http://localhost:8888/newshop/themes/Backend/ExtJs/backend/_resources/styles/tiny_mce.css?_dc=' + new Date().getTime(),
     ...
     */
    preloadImageUrl: '<?php echo '/newshop/backend/MediaManager/getMediaUrls';?>',
    ...
    replaceSmartyPluginWithImagePaths: function(rawContent) {
        ...
        Ext.each(images, function(img) {
            ...
            element.setAttribute('src', '/newshop/engine/Library/TinyMce/plugins/media_selection/assets/placeholder-image.png');
        });
