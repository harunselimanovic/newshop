<?php /* Smarty version Smarty-3.1.12, created on 2018-12-09 15:06:55
         compiled from "/Applications/MAMP/htdocs/newshop/themes/Backend/ExtJs/backend/index/controller/widgets.js" */ ?>
<?php /*%%SmartyHeaderCode:17306602315c0d217f0a7a56-82168571%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0ca07c7fb17d716962385d84eab4a7995615cefa' => 
    array (
      0 => '/Applications/MAMP/htdocs/newshop/themes/Backend/ExtJs/backend/index/controller/widgets.js',
      1 => 1543822814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17306602315c0d217f0a7a56-82168571',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5c0d217f1c3ca0_76321004',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c0d217f1c3ca0_76321004')) {function content_5c0d217f1c3ca0_76321004($_smarty_tpl) {?>/**
 * Shopware 5
...
An error occurred while attempting to delete the widget.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'error/deleteWidget','default'=>'An Error occurred while attempting to delete the widget.\\n\\n','namespace'=>'backend/index/controller/widgets'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1){?>*/
    ...
    onSaveWidgetPosition: function (column, row, internalId) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/newshop/backend/widgets/savePosition';?>',
            params: {
                column: column,
                position: row,
                id: internalId
    ...
    onSaveWidgetPositions: function (widgets) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/newshop/backend/widgets/savePositions';?>',
            jsonData: {
                widgets: widgets
            },
    ...
    onAddWidget: function (win, widgetName, menuItem, data) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/newshop/backend/widgets/addWidgetView';?>',
            jsonData: {
                id: widget.get('id'),
                column: 0,
    ...
    onCloseWidget: function (widget) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/newshop/backend/widgets/removeWidgetView';?>',
            params: {
                id: widget.viewId
            },
            callback: function (options, success, res) {
    ...
    onOpenMerchantDetail: function (mode, record) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/newshop/backend/widgets/requestMerchantForm';?>',
            params: {
                id: ~~(1 * record.get('id')),
