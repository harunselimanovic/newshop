<?php /* Smarty version Smarty-3.1.12, created on 2018-12-09 15:06:58
         compiled from "/Applications/MAMP/htdocs/newshop/themes/Backend/ExtJs/backend/customer/view/main/wizard.js" */ ?>
<?php /*%%SmartyHeaderCode:18571925435c0d2182866d03-38527279%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '89a311f9d5be8133b4602be1440ac230f42ece54' => 
    array (
      0 => '/Applications/MAMP/htdocs/newshop/themes/Backend/ExtJs/backend/customer/view/main/wizard.js',
      1 => 1543822814,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18571925435c0d2182866d03-38527279',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5c0d21828e1f98_02112709',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c0d21828e1f98_02112709')) {function content_5c0d21828e1f98_02112709($_smarty_tpl) {?>/**
 * Shopware 5
...
Next<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'next','namespace'=>'backend/customer/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
');
...
To module<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'finish','namespace'=>'backend/customer/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
');
            }
        } else {
            me.finish();
...
');
    ...
    createFirstPage: function() {
        var image = '/newshop/themes/Backend/ExtJs/backend/_resources/images/customer_stream/quick_view.jpg';
        if (Ext.userLanguage === 'de') {
            image = '/newshop/themes/Backend/ExtJs/backend/_resources/images/customer_stream/quick_view_de.jpg';
        }
...
Customer overview<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'wizard_customer_quick_view_headline','namespace'=>'backend/customer/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
' +
            '</h1>' +
...
' +
    ...
    createSecondPage: function() {
        var image = '/newshop/themes/Backend/ExtJs/backend/_resources/images/customer_stream/stream_view.jpg';
        if (Ext.userLanguage === 'de') {
            image = '/newshop/themes/Backend/ExtJs/backend/_resources/images/customer_stream/stream_view_de.jpg';
        }
...
Customer Streams overview<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'wizard_stream_view_headline','namespace'=>'backend/customer/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
' +
            '</h1>' +
            '<div class="description">' +
...
' +
    ...
    createFinishPage: function() {
        var image = '/newshop/themes/Backend/ExtJs/backend/_resources/images/customer_stream/ekw_usage.jpg';
        if (Ext.userLanguage === 'de') {
            image = '/newshop/themes/Backend/ExtJs/backend/_resources/images/customer_stream/ekw_usage_de.jpg';
        }
...
Usability<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'wizard_usage_headline','namespace'=>'backend/customer/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
' +
            '</h1>' +
            '<div class="description">' +
...
<p>The Customer Streams offer a strong re-usability in your shop.</p><p>For instance, you can define your own shopping world by Customer Streams, to suit the individual wishes of your customers.</p><p>In addition to that, you are able to limit coupons for certain customers and send out newsletters to different streams.</p><?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'wizard_usage_text','namespace'=>'backend/customer/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
' +
            '</div>' +
            '<div class="image">' +
                '<img src="' + image + '" />' +
...
Back<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'back','namespace'=>'backend/customer/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            cls: 'secondary',
            hidden: true,
...
Skip<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo FroshProfiler\Components\Smarty\SnippetResource::compileSnippetBlock(array('name'=>'skip','namespace'=>'backend/customer/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            cls: 'secondary',
